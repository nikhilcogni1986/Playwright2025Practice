...
test('Validating the left click on the button', async({page})=>
{
...
test('Validating the Double click on the button', async({page})=>
    {
        await page.goto("https://play1.automationcamp.ir/mouse_events.html");
...
test('Validating the right click on the button', async({page})=>
{
        await page.goto("https://play1.automationcamp.ir/mouse_events.html");
